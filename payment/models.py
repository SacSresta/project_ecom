...
class Order(models.Model):
    ...
    def __str__(self) -> str:
        return f'Order for {str(self.full_name)}, with order id :{str(self.id)} '
...
class PAIDORDER(Order):
    ...
    def __str__(self):
        return f'Paid Order: {self.full_name}'
...
class OrderItems(models.Model):
    ...
    variant = models.ForeignKey(ProductVariant, on_delete=models.CASCADE,null = True, related_name='variants')    
    user = models.ForeignKey(User, on_delete=models.CASCADE,null = True,blank=True)    
